...
export default function DashboardPage() {
  ...
  return `${metric.change > 0 ? "+" : ""}${metric.change}% ${metric.label}`;
};
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.new_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.new_users?.change ? `${metrics.new_users.change > 0 ? "+" : ""}${metrics.new_users.change}% from last week` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.total_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.total_users?.change ? `${metrics.total_users.change > 0 ? "+" : ""}${metrics.total_users.change}% from last week` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.posts?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.posts?.change ? `${metrics.posts.change > 0 ? "+" : ""}${metrics.posts.change}% from last week` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.restricted_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.restricted_users?.change ? `${metrics.restricted_users.change > 0 ? "+" : ""}${metrics.restricted_users.change}% from last week` : ""}
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.new_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.new_users?.change ? `${metrics.new_users.change > 0 ? "+" : ""}${metrics.new_users.change}% from last month` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.total_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.total_users?.change ? `${metrics.total_users.change > 0 ? "+" : ""}${metrics.total_users.change}% from last month` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.posts?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.posts?.change ? `${metrics.posts.change > 0 ? "+" : ""}${metrics.posts.change}% from last month` : ""}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics?.restricted_users?.count ?? "-"}</div>
              <p className="text-xs text-muted-foreground">
                {metrics?.restricted_users?.change ? `${metrics.restricted_users.change > 0 ? "+" : ""}${metrics.restricted_users.change}% from last month` : ""}
              </p>
            </CardContent>
          </Card>
        </div>
